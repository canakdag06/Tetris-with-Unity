...
{
    public static readonly float cos = Mathf.Cos(Mathf.PI / 2f);    // cos90
    public static readonly float sin = Mathf.Sin(Mathf.PI / 2f);    // sin90 (because rotations are 90 degrees)
    public static readonly float[] RotationMatrix = new float[] { cos, sin, -sin, cos };    // Clockwise rotation matrix for 2D Vectors
